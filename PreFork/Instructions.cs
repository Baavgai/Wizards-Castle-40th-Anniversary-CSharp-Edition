...
namespace The_Wizard_s_Castle
{
    class Instructions
    {
        static readonly List<string> content = new List<string>
        {
            "THE STORY",
        ...
        public static void ViewInstructions()
        {
            ...
            choice = gameMenu.Menu("Would you like to view the instructions", new Dictionary<char, string>
            {
            ...
            if (choice[0] == "Y")
            {
                ...
                foreach (string item in Instructions.content)
                {
