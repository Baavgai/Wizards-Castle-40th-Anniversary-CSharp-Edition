...
namespace WizardCastle {
    ...
    class Monster : Item, IHasOnEntry {
        ...
        private Monster(string name, int dexterity = 0, int intelligence = 0, int strength = 0, bool weaponBreakChance = false) : base(name, ItemType.Monster) {
            Mods = new Abilities() {
        ...
        public static Monster[] AllMonsters = new Monster[] {
