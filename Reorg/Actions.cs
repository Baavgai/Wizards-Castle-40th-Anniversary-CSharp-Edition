...
namespace WizardCastle {
    static class Actions {
        ...
        private class GameAction : IAction {
            ...
            public GameAction(char cmd, string name, string desc = null, Action<State> action = null) {
                Cmd = cmd;
                Name = name;
                Description = desc;
                this.action = action;
        ...
        public static readonly IAction[] AllActions = new IAction[] {
            new GameAction('M', "Show map", "(M)AP causes a map of the level you are currently on to be printed."),
            ...
            new GameAction('V', "View Instructions"),
