...
namespace The_Wizard_s_Castle.Models {
    ...
    class MapValue {
        ...
        private MapValue(string value) => this.value = value;
        public override string ToString() => value;

        public static readonly MapValue Clear = new MapValue("X");
        public static readonly MapValue Zot = new MapValue("Zot");
    }
    class Map {
